...
$sScreen = $sScreen . 							"<tr> ";
$sScreen = $sScreen . 								"<td width=|260|  height=|170| align=|left| valign=|top|><a href=|https://www.icreatives.com| border=0><img src=|https://port.icreatives.com/webtime/email/images/assets/logo.gif| width=|110| height=|123| border=|0| alt=|i creatives logo| style=|margin:15px 0px| /></td> ";
...
$sScreen = $sScreen . 								"<td align=|right|><b>PO Number: </b>" . $_REQUEST["PO"] . "</td> ";
														} else {														
$sScreen = $sScreen .								"<td> </td>";}
$sScreen = $sScreen . 							"</tr> ";
$sScreen = $sScreen . 							"<tr> ";
...
$sScreen = $sScreen . 											"<td align=|right|><span style=|color:#666|>" . Time2AmPm(($_REQUEST["TimeInHr" . $x]))  .  "</span></td>  " ;  	    	
$sScreen = $sScreen . 											"<td align=|right|><span style=|color:#666|>" . Time2AmPm(($_REQUEST["TimeOutHr" . $x]))  .  "</span></td>  " ;		
$sScreen = $sScreen . 											"<td align=|right|><span style=|color:#666|>" . $_REQUEST["BreakHr" . $x]  . "</span></td>  "  ; 
...
$sScreen = $sScreen . 						"<a href=|https://www.icreatives.com/find-talent/#get-in-touch-with-us| style=|color:#a4100c; font-weight:bold| title=|contact Us|>creatives.com/contact-us</a> "; 
$sScreen = $sScreen . 					"</td> ";
$sScreen = $sScreen . 					"<td> </td>";
$sScreen = $sScreen . 				"</tr> ";
$sScreen = $sScreen . 				"<tr > ";
