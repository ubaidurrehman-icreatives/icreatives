...
$sScreen = $sScreen . "<table width=|790| border=|0| align=|center| cellpadding=|0| cellspacing=|0| style=|font-family:Arial, Helvetica, sans-serif; font-size:12px; |> ";
  $sScreen = $sScreen . "<tr> ";
    $sScreen = $sScreen . "<td width=|570| align=|left| valign=|top| > ";

      $sScreen = $sScreen . "<!-- Content -->    "  . "\r\n"; 
      $sScreen = $sScreen . "<table width=|570| border=|0| cellpadding=|0| cellspacing=|0| > ";
              $sScreen = $sScreen . "<tr > ";
                $sScreen = $sScreen . "<td> </td>";
				// <img src=|https://www.icreatives.com/webtime/email/images/corners/corner-left-top.gif| width=|15| height=|15| border=|0| /></td> ";
                $sScreen = $sScreen . "<td> </td">";
				// <img src=|https://www.icreatives.com/webtime/email/images/sides/side-top.gif| width=|540| height=|15| border=|0| /></td> ";
                $sScreen = $sScreen . "<td> </td>";
				// <img src=|https://www.icreatives.com/webtime/email/images/corners/corner-right-top.gif| width=|15| height=|15| border=|0| /></td> ";
              $sScreen = $sScreen . "</tr> ";
              $sScreen = $sScreen . "<tr> ";
                $sScreen = $sScreen . "<td>< </td>";
			// 	img src=|https://www.icreatives.com/webtime/email/images/sides/side-left.gif| width=|15| height=|665| border=|0| /></td> ";
                ...
                $sScreen = $sScreen . "<table width=|500| border=|0| align=|center|> ";
  $sScreen = $sScreen . "<tr> ";
...
//   $sScreen = $sScreen . "<td width=|260|  height=|170| align=|left| valign=|top|><a href=|https://www.icreatives.com| border=0><img src=|cid:logo.gif| width=|110| height=|123| border=|0| alt=|i creatives logo| style=|margin:15px 0px| /></a></td> ";
  ...
  $sScreen = $sScreen . "<tr> ";
    ...
    $sScreen = $sScreen . "<table width=|500| border=|0| cellpadding=|4| style=|padding:4px 0px|> ";
  $sScreen = $sScreen . "<tr> ";
...
for ($x = 1; $x <= 7; $x++) {
 $sScreen = $sScreen . "<tr>  "   ;
    $sScreen = $sScreen . "<td align=|left| ><b>". jddayofweek($x-2,1) . "</b></td>  "   ;
		$sScreen = $sScreen . "<td align=|left|><span style=|color:#666|>" . "</span></td>  " ;  	    	
		$sScreen = $sScreen . "<td align=|left|><span style=|color:#666|>" . "</span></td>  " ;		
    $sScreen = $sScreen . "<td align=|left|><span style=|color:#666|>" ."</span></td>  "  ; 
    $sScreen = $sScreen . "<td align=|right|><b>" . "</b></td>  "   ;
 $sScreen = $sScreen . " </tr>  "   ;
}
  ...
  $sScreen = $sScreen . "<tr> ";
	...
	if ($_REQUEST["Continuing"] == "1") { 
	 ...
	 $sScreen = $sScreen . "</td> ";
    $sScreen = $sScreen . "<td colspan=|3| align=|right|><b style=|color:#a4100c|>Total: </b><b> " . "</b></td> ";
    $sScreen = $sScreen . "</tr> ";
    ...
    $sScreen = $sScreen . "<table border=|0| width=|400| cellpadding=|0| cellspacing=|0| style=|font-family:Arial, Helvetica, sans-serif; font-size:12px; |>";
      $sScreen = $sScreen . "<tr> ";
        $sScreen = $sScreen . "<td width=|195| align=|center| background=|/webtime/email/images/assets/click-here.gif| height=|38| bgcolor=|#9C0000|> ";
          $sScreen = $sScreen . "<a href=|". "https://www.icreatives.com" ."/index.php?pagename=portaltimeapprove&varib=1" . $MyNewRandomNum . "-" . $_REQUEST["xORDER"] . "| style=|color:#FFFFFF|><b>CLICK HERE TO APPROVE</B></a> ";
        $sScreen = $sScreen . "<td width=|5|></td> ";
        $sScreen = $sScreen . "<td width=|195| align=|center| background=|/webtime/email/images/assets/click-here.gif| height=|38| bgcolor=|#9C0000|> ";
// $_SERVER['HTTP_HOST']
          $sScreen = $sScreen . "<a href=|". "https://www.icreatives.com" ."/index.php?pagename=portaltimeapprove&varib=0" . $MyNewRandomNum . "-" . $_REQUEST["xORDER"] . "| style=|color:#FFFFFF|><B>CLICK HERE TO DECLINE</B></a> ";
  ...
  $sScreen = $sScreen . "</tr> ";
                ...
                $sScreen = $sScreen . "</td> ";
                $sScreen = $sScreen . "<td> </td";
				// <img src=|https://www.icreatives.com/webtime/email/images/sides/side-right.gif| width=|15| height=|665| border=|0| /></td> ";
              $sScreen = $sScreen . "</tr> ";
              $sScreen = $sScreen . "<tr > ";
                $sScreen = $sScreen . "<td> </td>";
				// <img src=|https://www.icreatives.com/webtime/email/images/corners/corner-left-bottom.gif| width=|15| height=|15| border=|0| /></td> ";
                $sScreen = $sScreen . "<td> </td>";
				// <img src=|https://www.icreatives.com/webtime/email/images/sides/side-bottom.gif| height=|15| width=|540| /></td> ";
                $sScreen = $sScreen . "<td> </td>";
				// <img src=|https://www.icreatives.com/webtime/email/images/corners/corner-right-bottom.gif| width=|15| height=|15| border=|0| /></td> ";
              $sScreen = $sScreen . "</tr> ";
      $sScreen = $sScreen . "</table> ";
    ...
    $sScreen = $sScreen . "<td width=|220| valign=|top|> ";
      ...
      $sScreen = $sScreen . "<table width=|220| border=|0| cellpadding=|0| cellspacing=|0| > ";
              $sScreen = $sScreen . "<tr > ";
                $sScreen = $sScreen . "<td align=|left| valign=|top|> </td>";
                ...
                $sScreen = $sScreen . "<td> </td>";
				// <img src=|https://www.icreatives.com/webtime/email/images/sides/side-top.gif| width=|190| height=|15| border=|0| /></td> ";
                $sScreen = $sScreen . "<td> </td>";
				// align=|right| valign=|top|  style=|background:url(/email/images/images/sides/side-right.gif) repeat-y|> ";
              ...
              $sScreen = $sScreen . "<tr> ";
              $sScreen = $sScreen . "<td> </td>";
			// 	<img src=|https://www.icreatives.com/webtime/email/images/sides/side-left.gif| width=|15| height=|85| border=|0| /></td> ";
                ...
                $sScreen = $sScreen . "<td> </td>";
				// <img src=|https://www.icreatives.com/webtime/email/images/sides/side-right.gif| width=|15| height=|85| border=|0| /></td> ";
              $sScreen = $sScreen . "</tr> ";
              $sScreen = $sScreen . "<tr > ";
                $sScreen = $sScreen . "<td> </td>";
				// align=|left| valign=|bottom|  style=|background:url(/email/images/images/sides/side-left.gif) repeat-y|> ";
                ...
                $sScreen = $sScreen . "<td> </td>";
				// img src=|https://www.icreatives.com/webtime/email/images/sides/side-bottom.gif| width=|190| height=|15| border=|0| /></td> ";
                $sScreen = $sScreen . "<td> </td>"; 
				// align=|right| valign=|bottom|  style=|background:url(/email/images/images/sides/side-right.gif) repeat-y|> ";
      ...
      $sScreen = $sScreen . "<table width=|220| border=|0| cellpadding=|0| cellspacing=|0| > ";
              $sScreen = $sScreen . "<tr > ";
                $sScreen = $sScreen . "<td> </td>";
//				align=|left| valign=|top|  style=|background:url(/email/images/images/sides/side-left.gif) repeat-y|> ";
                    // $sScreen = $sScreen . "<img src=|https://www.icreatives.com/webtime/email/images/corners/corner-left-top.gif| width=|15| height=|15| border=|0| /></td> ";
                $sScreen = $sScreen . "<td> </td>";
				// <img src=|https://www.icreatives.com/webtime/email/images/sides/side-top.gif| width=|190| height=|15| border=|0| /></td> ";
                $sScreen = $sScreen . "<td> </td>";
...
//$sScreen = $sScreen . "<img src=|https://www.icreatives.com/webtime/email/images/corners/corner-right-top.gif| width=|15| height=|15| border=|0| /></td> ";
              ...
              $sScreen = $sScreen . "<tr> ";
                $sScreen = $sScreen . "<td> </td>";
				// <img src=|https://www.icreatives.com/webtime/email/images/sides/side-left.gif| width=|15| height=|260| border=|0| /></td> ";
                $sScreen = $sScreen . "<td valign=|top|  style=|font-size:11px; ;padding:15px 5px; line-height:12px; color:#666;|> ";
                         ...
                         $sScreen = $sScreen . "</td> ";
                $sScreen = $sScreen . "<td> </td>";
				// <img src=|https://www.icreatives.com/webtime/email/images/sides/side-right.gif| width=|15| height=|260| border=|0| /></td> ";
              $sScreen = $sScreen . "</tr> ";
              $sScreen = $sScreen . "<tr > ";
                $sScreen = $sScreen . "<td> </td>"; 
				// align=|left| valign=|bottom|  style=|background:url(/email/images/images/sides/side-left.gif) repeat-y|> ";
...
$sScreen = $sScreen . "</td> "  . "\r\n"; 
  ...
  $sScreen = $sScreen . "<tr> ";
    $sScreen = $sScreen . "<td colspan=|2|> ";
      ...
      $sScreen = $sScreen . "<table width=|790| height=|100| border=|0| cellpadding=|0| cellspacing=|0|> <tr> ";
          $sScreen = $sScreen . "<td> </td>";
//		  align=|left| valign=|top|bgcolor=|#9C0000|><img src=|https://www.icreatives.com/webtime/email/images/footer/footer-left.gif| width=|15| height=|100| border=|0| /></td> ";
          $sScreen = $sScreen . "<td> </td>";
// 		  width=|760| height=|100| align=|center| valign=|middle| style=| font-weight:bold ;font-size:11px; color:#FFF | background=|/webtime/email/images/footer/footer-repeat.gif| bgcolor=|#9C0000|  > ";
	  ...
	  $sScreen = $sScreen . "</td> ";
          $sScreen = $sScreen . "<td> </td>";
// 		  align=|right| valign=|top| bgcolor=|#9C0000|><img src=|https://www.icreatives.com/webtime/email/images/footer/footer-right.gif| width=|15| height=|100| border=|0| /></td> ";
      $sScreen = $sScreen . "</tr></table> ";
$sScreen = $sScreen . "</td> ";
$sScreen = $sScreen . "</tr> ";
$sScreen = $sScreen . "</table> <P> <P>" . "\r\n"; 

$sScreen = $sScreen . "<table width=|790| border=|0| align=|center| cellpadding=|0| cellspacing=|0| style=|font-family:Arial, Helvetica, sans-serif; font-size:12px; |> <tr><td> ";
