...
for ($x = 1; $x <= 7; $x++) {
 $sScreen = $sScreen . "<tr>  "   ;
    $sScreen = $sScreen . "<td align=|left| ><b>". jddayofweek($x-2,1) . "</b></td>  "   ;
		$sScreen = $sScreen . "<td align=|left|><span style=|color:#666|>" . Time2AmPm(($_REQUEST["TimeInHr" . $x]))  .  "</span></td>  " ;  	    	
		$sScreen = $sScreen . "<td align=|left|><span style=|color:#666|>" . Time2AmPm(($_REQUEST["TimeOutHr" . $x]))  .  "</span></td>  " ;		
    $sScreen = $sScreen . "<td align=|left|><span style=|color:#666|>" . $_REQUEST["BreakHr" . $x] . " "  . "</span></td>  "  ; 
    ...
    $sScreen = $sScreen . "<table border=|0| width=|400| cellpadding=|0| cellspacing=|0| style=|font-family:Arial, Helvetica, sans-serif; font-size:12px; |>";
      $sScreen = $sScreen . "<tr> ";
        $sScreen = $sScreen . "<td width=|195| align=|center| background=|/webtime/email/images/assets/click-here.gif| height=|38| bgcolor=|#9C0000|> ";
          $sScreen = $sScreen . "<a href=|". "https://www.icreatives.com" ."/index.php?pagename=timeapprove&varib=1" . $MyNewRandomNum . "-" . $_REQUEST["xORDER"] . "| style=|color:#FFFFFF|><b>CLICK HERE TO APPROVE</B></a> ";
        $sScreen = $sScreen . "<td width=|5|></td> ";
        $sScreen = $sScreen . "<td width=|195| align=|center| background=|/webtime/email/images/assets/click-here.gif| height=|38| bgcolor=|#9C0000|> ";
// $_SERVER['HTTP_HOST']
          $sScreen = $sScreen . "<a href=|". "https://www.icreatives.com" ."/index.php?pagename=timeapprove&varib=0" . $MyNewRandomNum . "-" . $_REQUEST["xORDER"] . "| style=|color:#FFFFFF|><B>CLICK HERE TO DECLINE</B></a> ";
