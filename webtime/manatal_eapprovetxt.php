...
Function displayTimeIn($x){
		if ($_REQUEST["TimeInMin" . $x] == "0"){
			// $InTime=$_REQUEST["TimeInHr" . $x].":0".$_REQUEST["TimeInMin" . $x]. " ".$_REQUEST["TimeInAmPm"];
			$InTime=$_REQUEST["TimeInHr" . $x] ?? '0'.":0".$_REQUEST["TimeInMin" . $x] ?? '0'. " ".$_REQUEST["TimeInAmPm"] ?? '0';
		}else{
			$InTime=$_REQUEST["TimeInHr" . $x].":".$_REQUEST["TimeInMin" . $x]. " ".$_REQUEST["TimeInAmPm"];
		}
		return $InTime;
}
Function displayTimeOut($x){
		if ($_REQUEST["TimeOutMin" . $x] == "0"){
			$OutTime=$_REQUEST["TimeOutHr" . $x] ?? '0'.":0".$_REQUEST["TimeOutMin" . $x] ?? '0'. " ".$_REQUEST["TimeOutAmPm"] ?? '0';
		}else{
			$OutTime=$_REQUEST["TimeOutHr" . $x].":".$_REQUEST["TimeOutMin" . $x]. " ".$_REQUEST["TimeOutAmPm"];
		}
		return $OutTime;
}	
Function displayBreak($x){
		if ($_REQUEST["BreakMin" . $x] == "0"){
			$BreakTime=$_REQUEST["BreakHr" . $x].":0".$_REQUEST["BreakMin" . $x];
		}else{
			$BreakTime=$_REQUEST["BreakHr" . $x].":".$_REQUEST["BreakMin" . $x];
		}
		return $BreakTime;
}	
...
$sScreen = $sScreen . "<table width=|600| border=|0| align=|center| cellpadding=|0| cellspacing=|0| style=|align:left; font-family:Arial, Helvetica, sans-serif; font-size:12px; |> ";
$sScreen = $sScreen . 	"<tr> ";
$sScreen = $sScreen . 		"<td width=|600| align=|left| valign=|top| > ";
$sScreen = $sScreen . 			"<!-- Content -->    "  . "\r\n"; 
$sScreen = $sScreen . 			"<table style=| width:600px; border-spacing: 5px; border-radius:20px 20px 20px 20px;border: 2px solid #A50F14; |>";
$sScreen = $sScreen . 				"<tr > ";
...
$sScreen = $sScreen . 				"<tr> ";
$sScreen = $sScreen .					"<td> </td>";
$sScreen = $sScreen . 					"<td align=|center| valign=|top| style=|padding:10px 0;| background=|https://" . $_SERVER['HTTP_HOST'] . "/webtime/email/images/assets/background.gif|> ";
$sScreen = $sScreen . 						"<table width=|600| border=|0| align=|center|> ";
$sScreen = $sScreen . 							"<tr> ";
$sScreen = $sScreen . 								"<td width=|260|  height=|170| align=|left| valign=|top|><a href=|https://www.icreatives.com| border=0><img src=|https://" . $_SERVER['HTTP_HOST'] . "/webtime/email/images/assets/logo.gif| width=|110| height=|123| border=|0| alt=|i creatives logo| style=|margin:15px 0px| /></td> ";
$sScreen = $sScreen . 								"<td width=|230| align=|right| valign=|top| > ";
$sScreen = $sScreen . 									"<h1  style=|font-family:Arial; color:#a4100c; margin:0; padding:2px; font-size:30px|>TimeSheet</h1> ";
$sScreen = $sScreen . 									"<b>Week Ending:</b> " . date('m/d/Y',StrToTime($_REQUEST["WKEND"])) . " ";
$sScreen = $sScreen . 								"</td> ";
$sScreen = $sScreen . 							"</tr> ";
$sScreen = $sScreen .						 	"<tr> ";
$sScreen = $sScreen . 								"<td align=|left|><b style=|color:#a4100c|>Contractor: </b>" . $_REQUEST["EMP"] . "</td> ";  
														if (!empty($_REQUEST["PO"])) {
$sScreen = $sScreen . 								"<td align=|right|><b style=|color:#a4100c|>PO Number:  </b>" . $_REQUEST["PO"] . "</td> ";
														} else {														
$sScreen = $sScreen .								"<td> </td>";}
$sScreen = $sScreen . 							"</tr> ";
$sScreen = $sScreen . 							"<tr> ";
$sScreen = $sScreen . 								"<td  align=|left| valign=|top|><b style=|color:#a4100c|>Customer: </b> " . str_replace("_"," ",$_REQUEST["JOB"]) . "</td> ";
$sScreen = $sScreen . 								"<td> </td> ";
$sScreen = $sScreen . 							"</tr> ";
$sScreen = $sScreen .							 "<tr> ";
$sScreen = $sScreen . 								"<td align=|left| valign=|top|><b style=|color:#a4100c|>Position: </b> " . str_replace("_"," ",$_REQUEST["ITEM"]) . "</td> ";
$sScreen = $sScreen . 								"<td> </td> ";
$sScreen = $sScreen . 							"</tr> ";
$sScreen = $sScreen . 							"<tr> ";
$sScreen = $sScreen . 								"<td height=|220| colspan=|2| valign=|top|> ";
$sScreen = $sScreen . 									"<table width=|600| border=|0| cellpadding=|4| style=|padding:4px 0px|> ";
$sScreen = $sScreen . 										"<tr> ";
...
$sScreen = $sScreen . 										"</tr> ";
$sScreen = $sScreen . 										"<tr> ";
$sScreen = $sScreen . 											"<td colspan=|5| style=|border-top:solid 1px #ccc; height:5px|></td>";
$sScreen = $sScreen . 										"</tr> "  . "\r\n"; 
$grandtotal = 0;
for ($x = 1; $x <= 7; $x++) {
	$sScreen = $sScreen .							"<tr>  "   ;
	$sScreen = $sScreen . 							"<td align=|left| ><b>". jddayofweek($x-2,1) . "</b></td>  "   ;
	$sScreen = $sScreen . 							"<td align=|right|><span style=|color:#666|>" . displayTimeIn($x) .$_POST["TimeInAmPm" . $x] .  "</span></td>  " ;  	    	
	$sScreen = $sScreen . 							"<td align=|right|><span style=|color:#666|>" . displayTimeOut($x) .$_POST["TimeOutAmPm" . $x]   .  "</span></td>  " ;		
	$sScreen = $sScreen . 							"<td align=|right|><span style=|color:#666|>" . displayBreak($x). "</span></td>  "  ; 
	$sScreen = $sScreen . 							"<td align=|right|><b>" . TotalHrs($x). "</b></td>  "   ;
	$sScreen = $sScreen . 						"</tr>  "   ;
	// $grandtotal =  $grandtotal + $_REQUEST["TimeOutHr" . $x] - $_REQUEST["TimeInHr" . $x] - $_REQUEST["BreakHr" . $x]; 
}
$sScreen = $sScreen . 										"<tr> ";
$sScreen = $sScreen . 											"<td colspan=|5| style=|border-bottom:solid 1px #ccc; height:5px|></td> </tr> "  . "\r\n"; 
$sScreen = $sScreen . 										"<tr> ";
...
$sScreen = $sScreen . 									"<table border=|0| width=|400| cellpadding=|0| cellspacing=|0| style=|font-family:Arial, Helvetica, sans-serif; font-size:12px; |>";
$sScreen = $sScreen . 										"<tr> ";
$sScreen = $sScreen .											"<td width=|195| align=|center| background=|https://" . $_SERVER['HTTP_HOST'] . "/webtime/images/assets/click-here.gif| height=|38| bgcolor=|#9C0000|> ";
$sScreen = $sScreen . 												"<a href=|". "https://www.icreatives.com" ."/approve/?varib=1" . $MyNewRandomNum . "-" . $_REQUEST["xORDER"] . "| style=|color:#FFFFFF|><b>CLICK HERE TO APPROVE</B></a> ";
$sScreen = $sScreen . 											"<td width=|5|></td> ";
$sScreen = $sScreen . 											"<td width=|195| align=|center| background=|https://" . $_SERVER['HTTP_HOST'] . "/webtime/images/assets/click-here.gif| height=|38| bgcolor=|#9C0000|> ";
$sScreen = $sScreen . 												"<a href=|". "https://www.icreatives.com" ."/approve/?varib=0" . $MyNewRandomNum . "-" . $_REQUEST["xORDER"] . "| style=|color:#FFFFFF|><B>CLICK HERE TO DECLINE</B></a> ";
...
$sScreen = $sScreen . 							"</tr> ";
$sScreen = $sScreen . 							"<tr> ";
$sScreen = $sScreen . 								"<td colspan=|3| align=|left| valign=|bottom| height=|20px|><b>" . $_REQUEST["xORDER"] ."</b></td> ";
$sScreen = $sScreen . 							"</tr> ";
$sScreen = $sScreen . 						"</table> ";
$sScreen = $sScreen . 					"</td> ";
$sScreen = $sScreen . 					"<td> </td";
...
$sScreen = $sScreen . 			"</table> ";
$sScreen = $sScreen . 		"</td> ";
$sScreen = $sScreen . 		"<td width=|150| valign=|top| align=|left| style=|padding:0px 0px 0px 10px;|> ";  	
$sScreen = $sScreen . 			"<!-- CTA1 -->     "  . "\r\n"; 
$sScreen = $sScreen . 			"<table style=| padding:-0px; width:150px; border-spacing: 5px; border-radius:20px 20px 20px 20px;border: 2px solid #A50F14; |>";
...
$sScreen = $sScreen . 						"<a href=|https://" . $_SERVER['HTTP_HOST'] . "/find-talent/#get-in-touch-with-us| style=|color:#a4100c; font-weight:bold| title=|contact Us|>creatives.com/contact-us</a> "; 
$sScreen = $sScreen . 					"</td> ";
$sScreen = $sScreen . 					"<td> </td>";
$sScreen = $sScreen . 				"</tr> ";
$sScreen = $sScreen . 				"<tr > ";
...
// $sScreen = // $sScreen . 							"";
// $sScreen = // $sScreen . 							"<div align=|center|><img src="|https://" . $_SERVER['HTTP_HOST'] . "/webtime/images/assets/featured.jpg| style=|padding:10px| width=|96| height=|82| border=|0|   /></div> ";
...
// $sScreen = // $sScreen . 							"<a href="|https://" . $_SERVER['HTTP_HOST'] . "/featured-talent/| style=|color:#a4100c; font-weight:bold| title=|Feature Creative|>here</a> ";
...
// $sScreen = // $sScreen . 				"<tr > ";
// $sScreen = // $sScreen . 					"<td> </td>"; 
// $sScreen = // $sScreen . 					"<td><img src="|https://" . $_SERVER['HTTP_HOST'] . "/webtime/images/sides/side-bottom.gif| width=|190| height=|15| border=|0| /></td> ";
// $sScreen = // $sScreen . 					"<td> </td>";
// $sScreen = // $sScreen .				"</tr> ";
// $sScreen = $sScreen . 				"</table> -->";
/*
...
$sScreen = $sScreen . 							"<div align=|center|><img src="|https://" . $_SERVER['HTTP_HOST'] . "/webtime/images/assets/commercial.jpg| style=|align:left; padding:10px 0px 0px 0px;|  width=|115| height=|70| border=|0|   /></div> ";
$sScreen = $sScreen . 							"</A>";
...
$sScreen = $sScreen . 						"<td> </td>";
$sScreen = $sScreen . 						"<td>";
$sScreen = $sScreen . 							"<P><font color=|#FFFFFF|>This <A style=|color:#FFFFFF| Href=|https://port.icreatives.com|>i creatives</A> time approval is generated once our talent has completed an online timesheet for work performed for ";
...
$sScreen = $sScreen . 		"</tr> ";
$sScreen = $sScreen . 	"</table>"; 
$sScreen = $sScreen . "<table width=|650| border=|0| align=|center| cellpadding=|0| cellspacing=|0| style=|align:left; font-family:Arial, Helvetica, sans-serif; font-size:12px; |> ";
$sScreen = $sScreen . 		"<tr>";
$sScreen = $sScreen . 			"<td> ";
$sScreen = $sScreen . 				"<center><DIV style=|padding-top:20px;| align=justify><FONT size = |1| color=|#436376| width = |480|> ";
...
$sScreen = $sScreen . 				"Any timesheet that has not been approved or declined within five (5) calendar days from the initial submission date will be automatically considered approved. " . "\r\n";
$sScreen = $sScreen . 				"</FONT><BR> ";
$sScreen = $sScreen . 				"</DIV></center>";
$sScreen = $sScreen . 			"</td>";
$sScreen = $sScreen . 			"<td WIDTH=|160|> </td>";
$sScreen = $sScreen . 		"</tr>";
$sScreen = $sScreen . 	"</table> ";
$sScreen = $sScreen . "</body> ";
