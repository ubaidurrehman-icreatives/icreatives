<div class="rightpart" style="width:1068px;" >
          <div style="float:left;">
            <div style="clear:left; padding:0px 0 0 0px;">
              <div style="float:left; width:200px; height:41px;"><a href="/talent-home-graphic-web-designer-jobs/"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/returntocreativehome.png" alt="" /></a></div>
 ...
 <input type="text" name="First" id="First" placeholder="firstname" value="<?php the_field_value($item_num, "First", ""); ?>" style="width:150px;"  />
                ...
                <div style="float:left; padding:3px 40px 0 5px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/star_img.png" alt="" /> </div>
                <div style="float:left;">
            ...
            <div style="float:left; padding:25px 0 0 0px; ">
              <div style="float:left; width:334px; ">
                ...
                <div style="float:left; padding-left:70px;">
                  ...
                  <div style="float:left;   padding:20px 0 0 0px;">
                    <div style="float:left;;">
                      ...
                      <input type="text" maxlength="3" id="HOME_PHONE_AREA" maxlength="3" id="PHONE_AREA" name="HOME_PHONE_AREA" placeholder="area code" value="<?php the_field_value($item_num, "HOME_PHONE_AREA", ""); ?>" style="width:60px;"  />
                    </div>
                    <div style="float:left; height:9px; padding:9px 3px 0 3px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/dot_img.png" alt="" style="vertical-align:top;" /></div>
                    <div style="float:left;">
                      <input type="text" name="HOME_PHONE_PREFIX" maxlength="3" id="HOME_PHONE_PREFIX" placeholder="123" value="<?php the_field_value($item_num, "HOME_PHONE_PREFIX", ""); ?>" style="width:40px;" />
                    </div>
                    <div style="float:left; padding:9px 3px 0 3px;  height:9px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/dot_img.png" alt="" style="vertical-align:top;" /></div>
                    <div style="float:left;">
                ...
                <div style="float:left; padding-left:70px;">
                  <div style="float:left;  padding:20px 0 0 0px;">
                    <div style="float:left;">
                      <input type="text" maxlength="3" name="MOBILE_PHONE_AREA" id="MOBILE_PHONE_AREA"  placeholder="area code" value="<?php the_field_value($item_num, "MOBILE_PHONE_AREA", ""); ?>" style="width:60px;" />
                    </div>
                    <div style="float:left; padding:9px 3px 0 3px;  height:9px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/dot_img.png" alt="" style="vertical-align:top;" /></div>
                    <div style="float:left;">
                      <input type="text" maxlength="3" name="MOBILE_PHONE_PREFIX" id="MOBILE_PHONE_PREFIX" placeholder="123" value="<?php the_field_value($item_num, "MOBILE_PHONE_PREFIX", ""); ?>" style="width:40px;" />
                    </div>
                    <div style="float:left; padding:9px 3px 0 3px; height:9px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/dot_img.png" alt="" style="vertical-align:top;" /></div>
                    <div style="float:left;">
...
<!---               references ---->
 <div style="float:left; padding-top:30px;">
		<div style="float:left; padding:20px 0 0 70px;">
                ...
                <div style="float:left; padding:20px 0 0 0px;">
                  <div style="float:left;">
                    <input type="text" id="REFERENCE1_NAME" name="REFERENCE1_NAME" placeholder="reference 1 name" value="<?php the_field_value($item_num, "REFERENCE1_NAME", "");?>" style="width:305px;"  />
                  </div>
                  ...
                  <div style="float:left; padding-left:22px;">
                    <input type="text" id="REFERENCE1_URL" name="REFERENCE1_URL" placeholder="company url" value="<?php the_field_value($item_num, "REFERENCE1_URL", ""); ?>" style="width:257px;"   />
                  </div>
                ...
                <div style="float:left; padding:20px 0 0 0px;">
                  ...
                  <div style="float:left;">
                    <input type="email" name="REFERENCE1_EMAIL" id="REFERENCE1_EMAIL"  placeholder="reference email" value="<?php the_field_value($item_num, "REFERENCE1_EMAIL", ""); ?>" style="width:305px;" required />
                  </div>
		...
		<div style="float:left; padding:3px 0px 0 10px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/star_img.png" alt="" /> </div>
                  <div style="float:left; padding-left:0px;">
                    <div style="float:left; padding-left:22px;">
                    	<input type="text" id="REFERENCE1_RELATION" name="REFERENCE1_RELATION" placeholder="relationship" value="<?php the_field_value($item_num, "REFERENCE1_RELATION", ""); ?>" style="width:257px;"   />
                    </div>
                  <div style="float:left; padding:3px 0px 0 11px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/star_img.png" alt="" /> </div>
                  </div>
		</div>
...
<!---               references ---->
 <div style="float:left; padding-top:30px;">
		<div style="float:left; padding:20px 0 0 70px;">
                ...
                <div style="float:left; padding:20px 0 0 0px;">
                  <div style="float:left;">
                    <input type="text" id="REFERENCE2_NAME" name="REFERENCE2_NAME" placeholder="reference 2 name" value="<?php the_field_value($item_num, "REFERENCE2_NAME", "");?>" style="width:305px;" required  />
                  </div>
                  <div style="float:left; padding:3px 0px 0 9px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/star_img.png" alt="" /> </div>
                  <div style="float:left; padding-left:22px;">
                    <input type="text" id="REFERENCE2_URL" name="REFERENCE2_URL" placeholder="company url" value="<?php the_field_value($item_num, "REFERENCE2_URL", ""); ?>" style="width:257px;"   required />
                  </div>
                  <div style="float:left; padding:3px 0px 0 11px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/star_img.png" alt="" /> </div>
                </div>
                <div style="float:left; padding:20px 0 0 0px;">
                  ...
                  <div style="float:left;">
                    <input type="email" name="REFERENCE2_EMAIL" id="REFERENCE2_EMAIL"  placeholder="reference email" value="<?php the_field_value($item_num, "REFERENCE2_EMAIL", ""); ?>" style="width:305px;" required />
                  </div>

		<div style="float:left; padding:3px 0px 0 10px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/star_img.png" alt="" /> </div>
                  <div style="float:left; padding-left:0px;">
                    <div style="float:left; padding-left:22px;">
                    	<input type="text" id="REFERENCE2_RELATION" name="REFERENCE2_RELATION" placeholder="relationship" value="<?php the_field_value($item_num, "REFERENCE2_RELATION", ""); ?>" style="width:257px;" required />
                    </div>
                  <div style="float:left; padding:3px 0px 0 11px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/star_img.png" alt="" /> </div>
                  </div>
		</div>
...
<!---               references ---->
 <div style="float:left; padding-top:30px;">
		<div style="float:left; padding:20px 0 0 70px;">
                ...
                <div style="float:left; padding:20px 0 0 0px;">
                  <div style="float:left;">
                    <input type="text" id="REFERENCE3_NAME" name="REFERENCE3_NAME" placeholder="reference 3 name" value="<?php the_field_value($item_num, "REFERENCE3_NAME", "");?>" style="width:305px;" required  />
                  </div>
                  <div style="float:left; padding:3px 0px 0 9px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/star_img.png" alt="" /> </div>
                  <div style="float:left; padding-left:22px;">
                    <input type="text" id="REFERENCE3_URL" name="REFERENCE3_URL" placeholder="company url" value="<?php the_field_value($item_num, "REFERENCE3_URL", ""); ?>" style="width:257px;" required   />
                  </div>
                  <div style="float:left; padding:3px 0px 0 11px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/star_img.png" alt="" /> </div>
                </div>
                <div style="float:left; padding:20px 0 0 0px;">
                  ...
                  <div style="float:left;">
                    <input type="email" name="REFERENCE3_EMAIL" id="REFERENCE3_EMAIL"  placeholder="reference email" value="<?php the_field_value($item_num, "REFERENCE3_EMAIL", ""); ?>" style="width:305px;" required />
                  </div>

		<div style="float:left; padding:3px 0px 0 10px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/star_img.png" alt="" /> </div>
                  <div style="float:left; padding-left:0px;">
                    <div style="float:left; padding-left:22px;">
                    	<input type="text" id="REFERENCE3_RELATION" name="REFERENCE3_RELATION" placeholder="relationship" value="<?php the_field_value($item_num, "REFERENCE3_RELATION", ""); ?>" style="width:257px;" required   />
                    </div>
                  <div style="float:left; padding:3px 0px 0 11px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/star_img.png" alt="" /> </div>
                  </div>
		</div>
...
<!---         end      references ---->
            ...
            <div style="float:left; padding-top:30px;">
              ...
              <div style="float:left; padding:20px 0 0 70px;">
                ...
                <div style="float:left; padding:20px 0 0 0px;">
                  <div style="float:left;">
                    <input type="text" id="PAST1_COMPANY" name="PAST1_COMPANY" placeholder="company name" value="<?php the_field_value($item_num, "PAST1_COMPANY", "");?>" style="width:305px;" required  />
                  </div>
                  <div style="float:left; padding:3px 0px 0 9px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/star_img.png" alt="" /> </div>
                  <div style="float:left; padding-left:22px;">
                    <input type="text" id="PDF_PAST1_URL" name="PDF_PAST1_URL" placeholder="company url" value="<?php the_field_value($item_num, "PDF_PAST1_URL", ""); ?>" style="width:257px;" required   />
                  </div>
                  <div style="float:left; padding:3px 0px 0 11px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/star_img.png" alt="" /> </div>
                </div>
                <div style="float:left; padding:20px 0 0 0px;">
                  ...
                  <div style="float:left;">
                    <input type="email" name="PAST1_ADDRESS" id="PAST1_ADDRESS"  placeholder="supervisor email" value="<?php the_field_value($item_num, "PAST1_ADDRESS", ""); ?>" style="width:305px;" required />
                  </div>
		  ...
		  <div style="float:left; padding:3px 15px 0 10px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/star_img.png" alt="" /> </div>
                  ...
                  <div style="float:left; padding:3px 10px 0 5px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/star_img.png" alt="" /> </div>
                  ...
                  <div style="float:left;   padding:20px 0 0 0px;">
                    <div style="float:left;  padding-top:1px;">
                      ...
                      placeholder="area" value="<?php the_field_value($item_num, "PAST1_PHONE_AREA", ""); ?>" style="width:40px;"  />
                    </div>
                    <div style="float:left; height:9px; padding:9px 3px 0 3px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/dot_img.png" alt="" style="vertical-align:top;" /></div>
                    <div style="float:left; padding-top:1px;">
                      <input type="text" 
                      onkeyup="if($(this).val().length == '3'){ $('#PAST1_PHONE_SUBSCRIBER').focus();}"
                      name="PAST1_PHONE_PREFIX" id="PAST1_PHONE_PREFIX" placeholder="123" value="<?php the_field_value($item_num, "PAST1_PHONE_PREFIX", ""); ?>" style="width:40px;" />
                    </div>
                    <div style="float:left; padding:9px 3px 0 4px;  height:9px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/dot_img.png" alt="" style="vertical-align:top;" /></div>
                    <div style="float:left;  padding-top:1px;">
                      <input type="text" maxlength="4" id="PAST1_PHONE_SUBSCRIBER" name="PAST1_PHONE_SUBSCRIBER" placeholder="4567" value="<?php the_field_value($item_num, "PAST1_PHONE_SUBSCRIBER", ""); ?>" style="width:50px;"  />
                    </div>

                    <div style="float:left; padding-left:16px;">
                      <select  id="PAST1_CAN_CONTACT" name="PAST1_CAN_CONTACT" style="width:128px;">
		      ...
		      <input type="text"  id="PAST1_JOB_TITLE" name="PAST1_JOB_TITLE" placeholder="your job title" value="<?php the_field_value($item_num, "PAST1_JOB_TITLE", ""); ?>" style="width:257px;"  />
                    ...
                    <div style="float:left; padding:3px 0px 0 7px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/star_img.png" alt="" /> </div>
...
<!-- -->
                ...
                <div style="float:left; padding:20px 0 0 0px;">
                  ...
                  <div style="float:left;">
                    <input type="text" name="PAST2_ADDRESS" id="PAST2_ADDRESS"  placeholder="supervisor email" value="<?php the_field_value($item_num, "PAST2_ADDRESS", ""); ?>" style="width:305px;" />
                  </div>
		  ...
		  <div style="float:left; padding-left:40px;">
                  ...
                  <div style="float:left;   padding:20px 0 0 0px;">
                    <div style="float:left;  padding-top:1px;">
                      ...
                      placeholder="area code" value="<?php the_field_value($item_num, "PAST2_PHONE_AREA", ""); ?>" style="width:40px;"  />
                    </div>
                    <div style="float:left; height:9px; padding:9px 3px 0 3px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/dot_img.png" alt="" style="vertical-align:top;" /></div>
                    ...
                    <div style="float:left; padding-top:1px;">
                      ...
                      name="PAST2_PHONE_PREFIX" id="PAST2_PHONE_PREFIX" placeholder="123" value="<?php the_field_value($item_num, "PAST2_PHONE_PREFIX", ""); ?>" style="width:40px;" />
                    </div>
                    <div style="float:left; height:9px; padding:9px 3px 0 3px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/dot_img.png" alt="" style="vertical-align:top;" /></div>

                    <div style="float:left;  padding-top:1px;">
                      <input type="text" maxlength="4" id="PAST2_PHONE_SUBSCRIBER" name="PAST2_PHONE_SUBSCRIBER" placeholder="4567" value="<?php the_field_value($item_num, "PAST2_PHONE_SUBSCRIBER", ""); ?>" style="width:50px;"  />
                    </div>

                    <div style="float:left; padding-left:16px;">
                      <select  id="PAST2_CAN_CONTACT" name="PAST2_CAN_CONTACT" style="width:128px;">
		      ...
		      <input type="text"  id="PAST2_JOB_TITLE" name="PAST2_JOB_TITLE" placeholder="your job title" value="<?php the_field_value($item_num, "PAST2_JOB_TITLE", ""); ?>" style="width:257px;"  />
                    ...
                    <div style="float:left; padding-left:69px;">
...
<!-- -->
                ...
                <div style="float:left; padding:20px 0 0 0px;">
                  ...
                  <div style="float:left;">
                    <input type="text" name="PAST3_ADDRESS" id="PAST3_ADDRESS"  placeholder="supervisor email" value="<?php the_field_value($item_num, "PAST3_ADDRESS", ""); ?>" style="width:305px;" />
                  </div>
		  ...
		  <div style="float:left; padding-left:40px;">
                  ...
                  <div style="float:left;   padding:20px 0 0 0px;">
                    <div style="float:left;  padding-top:1px;">
                      ...
                      placeholder="area code" value="<?php the_field_value($item_num, "PAST3_PHONE_AREA", ""); ?>" style="width:40px;"  />
                    </div>
                    <div style="float:left; height:9px; padding:9px 3px 0 3px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/dot_img.png" alt="" style="vertical-align:top;" /></div>
                    ...
                    <div style="float:left; padding-top:1px;">
                      ...
                      name="PAST3_PHONE_PREFIX" id="PAST3_PHONE_PREFIX" placeholder="123" value="<?php the_field_value($item_num, "PAST3_PHONE_PREFIX", ""); ?>" style="width:40px;" />
                    </div>
                    <div style="float:left; height:9px; padding:9px 3px 0 3px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/dot_img.png" alt="" style="vertical-align:top;" /></div>

                    <div style="float:left;  padding-top:1px;">
                      <input type="text" maxlength="4" id="PAST3_PHONE_SUBSCRIBER" name="PAST3_PHONE_SUBSCRIBER" placeholder="4567" value="<?php the_field_value($item_num, "PAST3_PHONE_SUBSCRIBER", ""); ?>" style="width:50px;"  />
                    </div>

                    <div style="float:left; padding-left:16px;">
                      <select  id="PAST3_CAN_CONTACT" name="PAST3_CAN_CONTACT" style="width:128px;">
...
<!-- -->
            <div style="float:left; padding-top:30px;">
              ...
              <div style="float:left; padding:20px 0 0 70px;">
                ...
                <div style="clear:left; height:20px;"> </div>
                <div style="float:left;">
                  <input type="text" id="EDUC1_ADDRESS" name="EDUC1_ADDRESS" placeholder="city" value="<?php the_field_value($item_num, "EDUC1_ADDRESS", ""); ?>" style="width:152px;"  />
                </div>
                <div style="float:left; padding:3px 0px 0 5px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . StrToLower($formpath); ?>/images/star_img.png" alt="" /> </div>
