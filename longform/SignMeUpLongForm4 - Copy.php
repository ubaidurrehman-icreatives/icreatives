...
$RMail = $_POST['RMail'];         
	 ...
	 $link = mysqli_connect('localhost', 'wordpress_2', '9g1EXn$q8A','wordpress_7') or die("Error: " . mysqli_error());
       ...
       global $signupform;
        require_once($_SERVER['DOCUMENT_ROOT']. '/wp-content/themes/porto-child/longform/functions/form-functions.php');
        require_once($_SERVER['DOCUMENT_ROOT']. '/wp-content/themes/porto-child/longform/functions/List.php');
...
body {background:#ffffff;} 
        ...
        <?php include($_SERVER['DOCUMENT_ROOT'] . '\wp-content\themes\porto-child\LongForm\templates\signmeuplongform4.tpl.php'); ?>             
