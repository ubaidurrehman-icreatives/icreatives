...
// $target_dir = "C:/Inetpub/vhosts/alpha.icreatives.com/httpdocs/empact/ApplicationResumes/";
...
// echo "file type = " . $imageFileType . " XXX";
...
if($imageFileType != "rtf" && $imageFileType != "docx" && $imageFileType != "doc" ) {
    echo "Sorry, only RTF, DOC and DOCX files are allowed.";
    $uploadOk = 0;
}
...
<?php 
$msgbody = "";
$codes=file_get_contents ($_SERVER['DOCUMENT_ROOT'] . '/wp-content/themes/porto-child/longform/entake_fields.txt');
...
if (isset($_FILES['FILE1']) &&
	...
	if ($imageFileType == "doc" || $imageFileType == "rtf" || $imageFileType == "DOC" || $imageFileType == "RTF" ){
