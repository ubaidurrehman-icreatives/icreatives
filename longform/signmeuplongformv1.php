...
$formpath = "/wp-content/themes/vg-mirinae/LongForm";
...
// print "RMail = " . $RMail;
	 ...
	 mysql_select_db('wordpress_b');
        ...
        global $signupform;
         ...
         // require_once($_SERVER['DOCUMENT_ROOT'] . '/wp-content/custom-php/signup_process.php');


        include ($_SERVER['DOCUMENT_ROOT'] . '/wp-content/themes/vg-mirinae/longform/javascript.php');
...
body {background:#ffffff;} 
        ...
        <?php include($_SERVER['DOCUMENT_ROOT'] . '/wp-content/themes/porto-child/longform/templates/signmeuplongformv1.tpl.php'); ?>
