        <div class="rightpart" >
          <div style="float:left;">
            <div style="clear:left; padding:0px 0 0 0px;">
              ...
              <div style="float:left; width:468px;  height:41px;"><img src="https://<?php echo  $_SERVER['SERVER_NAME'] . '/' .  $_SERVER['PATH_INFO'] . $formpath; ?>/images/progressbar3.png" alt="" /></div>
...
<!--
           <form action="<?php echo CURRENTDOMAIN . '/empact/PHP_SubmitLongForm.asp'; ?>" ENCTYPE="multipart/form-data" method="post" id="signupform" name="signupform">
--> 
            <form action="<?php echo CURRENTDOMAIN . '/wp-content/themes/vg-mirinae/LongForm/SignMeUpLongUpload.php'; ?>" ENCTYPE="multipart/form-data" method="post" id="signupform" name="signupform">
          ...
          <div style="float:left;" >
            <div style="float:left;" class="btnbg">
              <div style="float:left; width:300px;  padding:16px 0 0 60px;"> <a href="#" class="whitetxt1"> management </a> </div>
            </div>
            <div style="clear:left; padding:20px 0 0 70px;">
              <div style="clear:left;" class="bottomarrow"> Account & Studio </div>
              <div style="clear:left; height:20px;"> </div>
              <div style="float:left; width:100px;" class="graytxt3"> Account Mng </div>
                <?php printRadio("SKILL_B05"); ?>

              <div style="float:left;  width:100px;" class="graytxt3"> Project Mng <br />
                Print </div>
              <?php printRadio("SKILL_B80"); ?>
                
              <div style="clear:left; height:8px;"> </div>
              <div style="float:left; width:100px;" class="graytxt3"> Marketing <br />
                Coordinator </div>
              <?php printRadio("SKILL_B15"); ?>
                
              <div style="float:left; width:100px;" class="graytxt3"> Project Mng <br />
                Web </div>
              <?php printRadio("SKILL_B85"); ?>

              <div style="clear:left; height:8px;"> </div>
              <div style="float:left; width:100px;" class="graytxt3"> Marketing <br />
                Director </div>
               <?php printRadio("SKILL_B20"); ?>
              
              <div style="float:left; width:100px;" class="graytxt3"> Producer Web </div>
              <?php printRadio("SKILL_B7350"); ?>
                
              <div style="clear:left; height:8px;"> </div>
              <div style="float:left; width:100px;" class="graytxt3"> Media Buyer <br />
                Broadcast </div>
                <?php printRadio("SKILL_B2525"); ?>
              
              <div style="float:left; width:100px;" class="graytxt3"> Producer Video <br />
                Broadcast </div>
              <?php printRadio("SKILL_B7330"); ?>
                

              <div style="clear:left; height:8px;"> </div>
              <div style="float:left; width:100px;" class="graytxt3"> Media Buyer <br />
                Web/Interactive </div>
              <?php printRadio("SKILL_B2550"); ?>
                
             
              <div style="float:left; width:100px;" class="graytxt3"> Production Mgr </div>
               <?php printRadio("SKILL_B75"); ?>

              <div style="clear:left; height:8px;"> </div>
              <div style="float:left; width:100px;" class="graytxt3"> Media Buyer <br />
                Print </div>
              <?php printRadio("SKILL_B2575"); ?>
                
               
              <div style="float:left; width:100px;" class="graytxt3"> Print Buyer/ <br />
                Estimator </div>
              <?php printRadio("SKILL_B65"); ?>
                
             
              <div style="clear:left; height:8px;"> </div>
              <div style="float:left; width:100px;" class="graytxt3"> Media Planner <br />
                Broadcast </div>
              <?php printRadio("SKILL_B4525"); ?>
                
              
              <div style="float:left; width:100px;" class="graytxt3"> Studio Mng </div>
              <?php printRadio("SKILL_B90"); ?>

              <div style="clear:left; height:8px;"> </div>
              <div style="float:left; width:100px;" class="graytxt3"> Media Planner <br />
                Print </div>
              <?php printRadio("SKILL_B4575"); ?>
                
              
              <div style="float:left; width:100px;" class="graytxt3"> Traffic Mng</div>
              <?php printRadio("SKILL_B95"); ?>


		<div style="clear:left; height:8px;"> </div>
              <div style="float:left; width:100px;" class="graytxt3"> Media Planner <br />
                Web/Interactive </div>
              <?php printRadio("SKILL_B4550"); ?>
          ...
          <div style="float:left; padding-top:30px;">
            ...
            <div style="float:left; padding:20px 0 0 70px;">
              ...
              <div style="float:left; padding:20px 0 0 0px;">
                <div style="float:left;">
                  <select id="AVAIL_START_MONTH" name="AVAIL_START_MONTH" class="styled" style=" width:138px;">
                    <?php MonthOption("AVAIL_START_MONTH", ""); ?>
                  </select> / 
                </div>
                <div style="float:left; padding-left:20px;">
                  <select id="AVAIL_START_DAY" name="AVAIL_START_DAY" class="styled" style=" width:127px;">
                    <?php DateOption("AVAIL_START_DAY"); ?>
                  </select> /
                </div>
                <div style="float:left; padding-left:20px;">
                  <select id="AVAIL_START_YEAR" name="AVAIL_START_YEAR" class="styled" style=" width:127px; z-index:1000">
                    <?php YearOption("AVAIL_START_YEAR", ""); ?>                    
                  </select>
                </div>
                <div style="float:left; padding:3px 0px 0 5px;"><img src="https://<?php echo  $_SERVER['SERVER_NAME'] . '/' .  $_SERVER['PATH_INFO'] . $formpath; ?>/images/star_img.png" alt="" /> </div>
              </div>
		...
		<div style="float:left; padding-left:15px;">
                <div style="float:left; padding:3px 10px 0 0px;"> <img src="https://<?php echo  $_SERVER['SERVER_NAME'] . '/' .  $_SERVER['PATH_INFO'] . $formpath; ?>/images/star_img.png" alt="" /> </div>
                ...
                <div style="float:left; padding:3px 0px 0 0px;"> <img src="https://<?php echo  $_SERVER['SERVER_NAME'] . '/' .  $_SERVER['PATH_INFO'] . $formpath; ?>/images/star_img.png" alt="" /> </div>
              </div>
              <div style="clear:left; height:40px;"> </div>
              <div style="float:left;">
              ...
              <div style="clear:left; padding-top:15px;">
                ...
                <div style="float:left; padding:3px 0px 0 8px;"> <img src="https://<?php echo  $_SERVER['SERVER_NAME'] . '/' .  $_SERVER['PATH_INFO'] . $formpath; ?>/images/star_img.png" alt="" /> </div>
                ...
                <div style="float:left; padding:3px 0px 0 14px;"> <img src="https://<?php echo  $_SERVER['SERVER_NAME'] . '/' .  $_SERVER['PATH_INFO'] . $formpath; ?>/images/star_img.png" alt="" /> </div>
              </div>
              <div style="clear:left; height:40px;"> </div>
              <div style="float:left;">
          ...
          <div style="float:left; padding-top:50px;">
            ...
            <div style="float:right; padding:30px 20px 30px 0;"> 
        	<input type="image" name="Submit" onclick="return submit_app();" src="https://<?php echo  $_SERVER['SERVER_NAME'] . '/' . $_SERVER['PATH_INFO'] . $formpath; ?>/images/finish_button.jpg" style="height:auto; background-color:#FFF; border:none;">
		</div>
