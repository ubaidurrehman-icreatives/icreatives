...
$formpath = "/wp-content/themes/porto-child/LongForm";
	...
	$candidate_email = str_replace("@","%40",$RMail);
	
	$response = $client->request('GET', 'https://api.manatal.com/open/v3/candidates/?email='.$candidate_email.'', [
		'headers' => [
	...
	$candidate_data = json_decode($responseStr, true);
...
body {background:#ffffff;} 
        ...
        <?php include($_SERVER['DOCUMENT_ROOT'] . '/wp-content/themes/porto-child/longform/m_signmeuplongform.tpl.php'); ?>
