                ...
                <div style="float:left; padding-left:70px;">
                  ...
                  <div style="float:left;   padding:20px 0 0 0px;">
                    ...
                    <div style="float:left;">
                      ...
                      name="HOME_PHONE_PREFIX" id="HOME_PHONE_PREFIX" placeholder="123" value="<?php the_field_value($item_num, "HOME_PHONE_PREFIX", ""); ?>" style="width:40px;" />
                    </div>
                ...
                <div style="float:left; padding-left:70px;">
                  <div style="float:left;  padding:20px 0 0 0px;">
                    ...
                    <div style="float:left;">
                      ...
                      name="MOBILE_PHONE_PREFIX" id="MOBILE_PHONE_PREFIX" placeholder="123" value="<?php the_field_value($item_num, "MOBILE_PHONE_PREFIX", ""); ?>" style="width:40px;" />
                    </div>
                    <div style="float:left; padding:9px 3px 0 3px; height:9px;"><img src="<?php echo  $_SERVER['PATH_INFO'] . $formpath; ?>/images/dot_img.png" alt="" style="vertical-align:top;" /></div>
                    <div style="float:left;">
