<center>
  ...
  <div style="float:left; text-align: center; width:95%; padding-top:15px;">
          ...
          <div style="float:left; padding-top:8px;">
            <div style="float:left; width:310px;" > <img src="/longform/images/applyimg.png" alt="" /> </div>
...
<!--
                  ...
                  <div style="float:left; padding:3px 25px 0 5px;">
                    <img src="/longform/images/star_img.png" alt="" /> 
                  </div>
...
<input type="image" name="Submit" onclick="return all_required_filed_valid();" src="/longform/images/nextskills.png" style="height:auto; background-color:#FFF; border:none;">
</div>
