...
switch ($page) {
    ...
    case "tracker":
	echo '<div style="text-align:center;"> ';
	echo "<iframe name='import' src='/mngr/webtime/TRMS_IMPORT.asp?varib1=" . $_SESSION["User_ID"] . "&varib2=" . $_SESSION["Upass"] . "'  width=95% height=2000 style='border:2px solid #b22625;'></iframe>";
	echo '</div>';
