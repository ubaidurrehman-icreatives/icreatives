...
$strSQL2 = $strSQL . " AND (NOT void or void = '' or void IS NULL) GROUP BY wt.invoice_number ORDER BY INVNUM DESC,wt.first_name ASC LIMIT 50 ";
...
$invnum = $nextinvoice-1;
	...
	// echo "count = ".count($recipients);
		...
		// /var/www/vhosts/icreatives.com/httpdocs/portal/random_compat/vendor/autoload.php
			include( '/var/www/vhosts/icreatives.com/httpdocs/mngr/manatal_old_invoice_inc.php');
