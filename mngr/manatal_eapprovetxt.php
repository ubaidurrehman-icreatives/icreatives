	...
	<tr>
		<td width=|600| align=|left| valign=|top| >
			...
			<table style=| width:600px; border-spacing: 5px; border-radius:20px 20px 20px 20px;border: 2px solid #A50F14; |>
				...
				<tr>
					<td>&nbsp;</td>
					<td align=|center| valign=|top| style=|padding:10px 0;| background=|https://port.icreatives.com/webtime/email/images/assets/background.gif|>
						<table width=|600| border=|0| align=|center|> 
							<tr>
								<td width=|260|  height=|170| align=|left| valign=|top|><a href=|https://port.icreatives.com| border=0><img src=|https://port.icreatives.com/webtime/email/images/assets/logo.gif| width=|110| height=|123| border=|0| alt=|i creatives logo| style=|margin:15px 0px| />
								</td>
									...
									<table border=|0| width=|400| cellpadding=|0| cellspacing=|0| style=|font-family:Arial, Helvetica, sans-serif; font-size:12px; |>
										<tr>
											<td width=|195| align=|center| background=|/webtime/email/images/assets/click-here.gif| height=|38| bgcolor=|#9C0000|>
												<a href=|". "https://www.icreatives.com" ."/approve/?varib=1" . $row2["UNUMB"] . "-" . $row2["xORDER"] . "| style=|color:#FFFFFF|><b>CLICK HERE TO APPROVE</B></a>
											</td>
											<td width=|5|></td>
											<td width=|195| align=|center| background=|/webtime/email/images/assets/click-here.gif| height=|38| bgcolor=|#9C0000|>
												<a href=|". "https://www.icreatives.com" ."/approve/?varib=0" . $row2["UNUMB"]. "-" . $row2["xORDER"] . "| style=|color:#FFFFFF|><B>CLICK HERE TO DECLINE</B></a>
												</b></font>
											</td>
											<td width=|5|></td>
										</tr>
