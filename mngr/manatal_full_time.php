...
?>
    ...
    Salary: $<?php echo number_format($row['salary'],2) ?> - Fee Percent: - <?php echo $row['fee_percent'] ?>% - Terms: <?php echo ($row['terms'] ?? '') ?><p>
    ...
    Terms: <input type='text' style='width:200px;' name='terms' value='<?php echo ($row['terms'] ?? 0); ?>' required><p>
