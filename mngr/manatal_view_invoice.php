...
$strSQL = "SELECT c.* 'TIMEACT' as '!TIMEACT' ";
...
$strSQL = $strSQL . "LEFT JOIN ic_company c ON (oj.organization = c.organization) ";
$strSQL = $strSQL . "WHERE wt.invoice_number = ".$invnum." ";

$strSQL2 = $strSQL . " AND NOT void GROUP BY wt.invoice_number ORDER BY INVNUM DESC,wt.first_name ASC ";
...
$invnum = $nextinvoice-1;
	...
	// echo "count = ".count($recipients);
		...
		// /var/www/vhosts/icreatives.com/httpdocs/portal/random_compat/vendor/autoload.php
			include( '/var/www/vhosts/icreatives.com/httpdocs/mngr/manatal_invoice_inc.php');
...
// 			// Start Making Timesheets
			...
			while ($row6 = mysqli_fetch_array($result6)) {	
				include( '/var/www/vhosts/icreatives.com/httpdocs/mngr/manatal_timesheet_inc.php');
