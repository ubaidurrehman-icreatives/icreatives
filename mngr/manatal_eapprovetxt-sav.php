...
$sScreen = $sScreen . 									"<b>Week Ending:</b> " . date('m/d/Y',StrToTime($row2["WKEND"])) . " ";
$sScreen = $sScreen . 								"</td> ";
$sScreen = $sScreen . 							"</tr> ";
$sScreen = $sScreen .						 	"<tr> ";
$sScreen = $sScreen . 								"<td align=|left|><b style=|color:#a4100c|>Contractor: </b>" . $row2["FIRST"] . "</td> ";  
														if (!empty($row2["PO"])) {
...
$sScreen = $sScreen . 							"</tr> ";
$sScreen = $sScreen . 							"<tr> ";
$sScreen = $sScreen . 								"<td  align=|left| valign=|top|><b style=|color:#a4100c|>Customer: </b> " . str_replace("_"," ",$row2["JOB"]) . "</td> ";
$sScreen = $sScreen . 								"<td>&nbsp;</td> ";
$sScreen = $sScreen . 							"</tr> ";
$sScreen = $sScreen .							 "<tr> ";
$sScreen = $sScreen . 								"<td align=|left| valign=|top|><b style=|color:#a4100c|>Position: </b> " . str_replace("_"," ",$row2["ITEM"]) . "</td> ";
$sScreen = $sScreen . 								"<td>&nbsp;</td> ";
$sScreen = $sScreen . 							"</tr> ";
$sScreen = $sScreen . 							"<tr> ";
...
$sScreen = $sScreen . 											"<td width=|90| align=|right|><b>In</b></td> ";
$sScreen = $sScreen . 											"<td width=|90| align=|right|><b>Out</b></td> ";
$sScreen = $sScreen . 											"<td width=|90| align=|right|><b>Break</b></td> ";
...
$sScreen = $sScreen . 												"<a href=|". "https://www.icreatives.com" ."/index.php?pagename=approve-timesheet&varib=1" . $row2["UNUMB"] . "-" . $row2["xORDER"] . "| style=|color:#FFFFFF|><b>CLICK HERE TO APPROVE</B></a> ";
$sScreen = $sScreen . 											"<td width=|5|></td> ";
$sScreen = $sScreen . 											"<td width=|195| align=|center| background=|/webtime/email/images/assets/click-here.gif| height=|38| bgcolor=|#9C0000|> ";
$sScreen = $sScreen . 												"<a href=|". "https://www.icreatives.com" ."/index.php?pagename=approve-timesheet&varib=0" . $row2["UNUMB"]. "-" . $row2["xORDER"] . "| style=|color:#FFFFFF|><B>CLICK HERE TO DECLINE</B></a> ";
...
$sScreen = $sScreen . 							"</tr> ";
$sScreen = $sScreen . 							"<tr> ";
$sScreen = $sScreen . 								"<td colspan=|3| align=|left| valign=|bottom| height=|20px|><b>" . $row2["xORDER"] ."</b></td> ";
$sScreen = $sScreen . 							"</tr> ";
$sScreen = $sScreen . 						"</table> ";
$sScreen = $sScreen . 					"</td> ";
$sScreen = $sScreen . 					"<td>&nbsp;</td";
