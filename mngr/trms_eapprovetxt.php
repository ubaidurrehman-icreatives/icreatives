    ...
    $sScreen = $sScreen . "<table border=|0| width=|400| cellpadding=|0| cellspacing=|0| style=|font-family:Arial, Helvetica, sans-serif; font-size:12px; margin-left: auto; margin-right: auto; margin-top: 0; margin-bottom: 0 border-spacing: 0;|>";
      $sScreen = $sScreen . "<tr> ";
        $sScreen = $sScreen . "<td width=|195| align=|center| background=|/webtime/email/images/assets/click-here.gif| height=|38| bgcolor=|#9C0000|> ";
          $sScreen = $sScreen . "<a href=|". "https://www.icreatives.com" ."/index.php?pagename=portaltimeapprove&varib=1" . $row2["UNUMB"]. "-" . $row2["xORDER"] . "| style=|color:#FFFFFF|><b>CLICK HERE TO APPROVE</B></a> ";
        $sScreen = $sScreen . "<td width=|5|></td> ";
        $sScreen = $sScreen . "<td width=|195| align=|center| background=|/webtime/email/images/assets/click-here.gif| height=|38| bgcolor=|#9C0000|> ";
// $_SERVER['HTTP_HOST']
          $sScreen = $sScreen . "<a href=|". "https://www.icreatives.com" ."/index.php?pagename=portaltimeapprove&varib=0" . $row2["UNUMB"] . "-" . $row2["xORDER"] . "| style=|color:#FFFFFF|><B>CLICK HERE TO DECLINE</B></a> ";
