...
<h1>MANATAL APPROVE TIMESHEETS FOR INVOICE AND PAYROLL</h1>
<?php
...
$strSQLn = $strSQL . "ORDER BY `PAY_GROUP` ASC, WeekEnding ASC, last_name ASC;";
...
// 		AND wt.Assignment_ID = '". $PROJ[$i]."' AND wt.Weekending = '" .$WKEND[$i]. "'";
		...
		$update_sql = "UPDATE ic_timesheets SET ExportDate = NOW() WHERE  Unique_ID = '". $recipients[$i]."'";
		// echo $update_sql;
