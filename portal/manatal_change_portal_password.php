  ...
  <div class="row justify-content-center">
    <form class="form" id="reset" action="/portal/customer/manatal_send_client_reset.php" method="post">
      ...
      <div class="form-group">
        ...
        <input type="email" class="form-control" id="email" name="email" value="<?php if(isset($_SESSION['user'])) echo $_SESSION['user'] ?>" placeholder="email" required>
      </div>
      <div class="form-group">
        <div class="row">
          <div class="col">
            <button type="button" class="btn btn-primary" onclick="document.location.assign('/portals<?php if(isset($_SESSION['user'])) echo "/?user=".$_SESSION['user'] ?>')">Back to Login</button>
          </div>
