...
<div class="container custom">
  ...
  <?php 
	...
	?>
<!-- Start Form -->
  <form class="form-login" id="servicelogin" action="/portal/customer/manatal_process_email2_tai.php" method="post" novalidate>
      ...
      <div class="message">
        ...
        if(isset($_REQUEST['r'])) {
          if($_REQUEST['r'] == 'fields') {
            ...
            echo '<div class="alert alert-danger">No Active Assignments</div>';
          } else {
