  ...
  <div class="row justify-content-center">
    <form class="form" id="reset" action="/portal/customer/manatal_send_talent_reset.php" method="post">
      ...
      <div class="form-group">
        <div class="row">
          <div class="col">
            <button type="button" class="btn btn-primary" onclick="document.location.assign('/login.php<?php if(isset($_REQUEST['user'])) echo "/?user=".$_REQUEST['user'] ?>')">Back to Login</button>
          </div>
